...
class PDF extends FPDF
{
    ...
    function datosHorizontal($datos)
    {
        ...
        foreach($datos as $fila)
        {
            ...
            $this->CellFitSpace(40,7, utf8_decode($fila['a']),0, 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['b']),'LR', 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['c']),'LR', 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['d']),0, 0 , 'L' );
            $this->Ln();
