...
<!--                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <h2> Bienvenido</h2>
                <p>Mediante este formulario usted puede registrar un curso.</p>
                <form role="form" class="form-horizontal" action="../controlador/agregarCurso.php" method="post">
                            <div class="form-group">
             <?php if($err==1){ echo "<div class='alert alert-danger text-center'>
                            <strong>Advertencia: </strong>el codigo del curso ya esta asignado</div> ";  } ?>
			<?php if($err==2){
				echo "<div class='alert alert-success text-center'>
                            <strong>Advertencia: </strong>Su registro ha sido guardado</div>";
			}?>
                        <?php if($err==3){
				echo "<div class='alert alert-danger text-center'>
                    ...
                    <div class="form-group">
                        <label for="nombres" class="control-label col-xs-4">Nombre:</label>
                        <div class="col-xs-5">
                            <input id="nombres" name="nombres" type="text" class="form-control" placeholder="Escriba el nombre del curso" onkeyup="validacion('nombres');">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-5">
                            <button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-lock"></span> Registrar</button>   
                        </div>
                    </div>                 
                </form>
            </div>
