...
$co =isset($_SESSION['plones']) ? $_SESSION['plones'] : null ;
$cod =isset($_SESSION['plon']) ? $_SESSION['plon'] : null ;
$cont = 0;
if($user == ''){
...
<!--                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
             <h2> Bienvenido</h2>
                <p>Ahora debe seleccionar las preguntas para el examen.</p>
                <form action="../controlador/guardarPregunta.php" method="post">
        ...
        <tbody>
             <?php
              ...
              require '../modelo/Conexion.php';
                    $uDao = new PreguntaDao();
                    $allusers = $uDao->preguntas($co);
                   foreach($allusers as $user) {?>
                <tr><td><?php echo $user['b']; ?> </td>
                    <td><div class="radio">
                            <label class="radio-inline"><input type="radio" name="<?php echo "cod".$cont;?>" value="<?php echo $user['a']; ?>">Activar</label>
                            <label class="radio-inline"><input type="radio" name="<?php echo "cod".$cont;?>" value="0" checked="checked">Desactivar</label> </div>
 </td>
                </tr>
                <?php
                 $cont = $cont+1;    }?>
                    ...
                    <div><input style="visibility: hidden;" type="text" name="cont" value="<?php echo $cont; ?>"></div>
                    <div><input style="visibility: hidden;" type="text" name="exa" value="<?php echo $cod; ?>"></div>
                <div class="col-xs-5">
